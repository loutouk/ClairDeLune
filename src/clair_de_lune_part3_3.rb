...
in_thread do
  # Trebble clef
  # 34
  play :Bb5, release: 3 * tempo + overlap_release, amp: default_amp
  sleep 3 * tempo
  play :Ab5, release: 1.5 * tempo + overlap_release, amp: default_amp
  sleep 1.5 * tempo
  # 35
  play :Fb5, release: 3 * tempo + overlap_release, amp: default_amp
  play :Ab5, release: 3 * tempo + overlap_release, amp: default_amp
  sleep 3 * tempo
  play :Ab5, release: 1 * tempo + overlap_release, amp: default_amp
  play :Cb6, release: 1 * tempo + overlap_release, amp: default_amp # flat
  sleep 1 * tempo
  ...
  play :Ab5, release: 3 * tempo + overlap_release, amp: default_amp
  sleep 3 * tempo
  play :Gs5, release: 1 * tempo + overlap_release, amp: default_amp # sharp
  play :B5, release: 1 * tempo + overlap_release, amp: default_amp # natural
  sleep 1 * tempo
  play :Gs5, release: 0.5 * tempo + overlap_release, amp: default_amp # sharp
  sleep 0.5 * tempo
...
# Bass clef
# 34
play :D4, release: 0.375 * tempo + overlap_release, amp: default_amp # natural
sleep 0.25 * tempo
...
sleep 0.25 * tempo
play :Eb4, release: 0.375 * tempo + overlap_release, amp: default_amp
sleep 0.25 * tempo
play :G4, release: 0.25 * tempo + overlap_release, amp: default_amp
sleep 0.25 * tempo
play :Bb4, release: 0.25 * tempo + overlap_release, amp: default_amp
...
play :Bb5, release: 0.25 * tempo + overlap_release, amp: default_amp
sleep 0.25 * tempo
play :Ab3, release: 0.375 * tempo + overlap_release, amp: default_amp
...
sleep 0.25 * tempo
# 35
play :D3, release: 0.375 * tempo + overlap_release, amp: default_amp
sleep 0.25 * tempo
...
sleep 0.25 * tempo
play :Fb3, release: 0.375 * tempo + overlap_release, amp: default_amp
play :Ab3, release: 0.25 * tempo + overlap_release, amp: default_amp
sleep 0.25 * tempo
play :Cb4, release: 0.25 * tempo + overlap_release, amp: default_amp
sleep 0.25 * tempo
...
sleep 0.25 * tempo
# 36
play :D3, release: 0.375 * tempo + overlap_release, amp: default_amp # natural
sleep 0.25 * tempo
play :Ab3, release: 0.25 * tempo + overlap_release, amp: default_amp
sleep 0.25 * tempo
play :D4, release: 0.25 * tempo + overlap_release, amp: default_amp
...
play :Fb5, release: 0.25 * tempo + overlap_release, amp: default_amp
sleep 0.25 * tempo
play :Gs3, release: 0.375 * tempo + overlap_release, amp: default_amp # sharp
