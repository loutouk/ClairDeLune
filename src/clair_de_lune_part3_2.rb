...
in_thread do
  ...
  sleep 0.25 * tempo
  play :Fb5, release: 0.75 * tempo + overlap_release, amp: default_amp
  sleep 0.25 * tempo
  play :G4, release: 0.25 * tempo + overlap_release, amp: default_amp
  sleep 0.25 * tempo
  play :Bb4, release: 0.25 * tempo + overlap_release, amp: default_amp
  ...
  play :Bb4, release: 0.25 * tempo + overlap_release, amp: default_amp
  sleep 0.25 * tempo
  play :Eb5, release: 0.75 * tempo + overlap_release, amp: default_amp # natural
  sleep 0.25 * tempo
  play :G4, release: 0.25 * tempo + overlap_release, amp: default_amp
  sleep 0.25 * tempo
  play :Bb4, release: 0.25 * tempo + overlap_release, amp: default_amp
...
sleep 0.25 * tempo
play :Ab3, release: 0.25 * tempo + overlap_release, amp: default_amp # natural
sleep 0.25 * tempo
play :Cb4, release: 0.5 * tempo + overlap_release, amp: default_amp
sleep 0.5 * tempo
# 33
play :Eb2, release: 0.375 * tempo + overlap_release, amp: default_amp
sleep 0.25 * tempo
...
sleep 0.25 * tempo
play :G4, release: 0.75 * tempo + overlap_release, amp: default_amp
sleep 0.75 * tempo
play :Fb4, release: 0.75 * tempo + overlap_release, amp: default_amp
sleep 0.75 * tempo
play :D4, release: 0.75 * tempo + overlap_release, amp: default_amp # natural
sleep 0.75 * tempo
play :Eb4, release: 0.75 * tempo + overlap_release, amp: default_amp
sleep 0.75 * tempo
# End of page 3 part 2